...
class MainWin(tk.Tk):
    def __init__(self):
        ...
        self.measurement_duration=960
        
        
        self.arduino_reply = Console(self.client, '', 'ard')

        self.ard = Machine.MachineObj('/dev/ttyACM0', self.arduino_reply)   # CORRECT PORT
        #self.ard = Machine.MachineObj('COM7', self.arduino_reply)

        self.ld_n2o_console = Console(self.client, self.topic, 'ld/n2o')
        self.ld_n2o = LaserDriver.LaserObj("/dev/ttyUSB0", self.ld_n2o_console,'n2o',2500,400,900,50,1,self.measurement_duration)         # CORRECT PORT
        #self.ld_n2o = LaserDriver.LaserObj("COM4", self.ld_n2o_console,'n2o',2500,400,900,50,'1',self.measurement_duration)  #need to have multiple options [serial_address,name,Temperature,RampMin,RampMax,RampTime]
        
        # Co2
        self.ld_co2_console = Console(self.client, self.topic, 'ld/co2')
        self.ld_co2 = LaserDriver.LaserObj("/dev/ttyUSB2", self.ld_co2_console,'co2',2950,2820,3620,45,2,self.measurement_duration)         # CORRECT PORT
        #self.ld_co2 = LaserDriver.LaserObj("COM7", self.ld_co2_console,'co2',2950,2820,3620,45,'2',self.measurement_duration)         # CORRECT PORT

        # Ch4
        self.ld_ch4_console = Console(self.client, self.topic, 'ld/ch4')
        self.ld_ch4 = LaserDriver.LaserObj("/dev/ttyUSB1", self.ld_ch4_console,'ch4',1700,1620,2060,51,3,self.measurement_duration)         # CORRECT PORT
        #self.ld_ch4 = LaserDriver.LaserObj("COM3", self.ld_ch4_console,'ch4',1700,1680,2060,40,'3',self.measurement_duration)         # CORRECT PORT
        ...
        self.LD_States(1,0)
        self.DataInterface(1,1)  
        self.RampInterface(1,2)

        self.LD_Select(2,1)
        self.LaserWidgets(3,1)
    ...
    def MachineWidgets(self,x,y):
        ...
        self.MachineFrame.grid(row=x,column=y,columnspan=2,sticky='news')
    ...
    def LD_Select(self,x,y):  # Draws buttons ,etc.
        ...
        self.LD_SelectFrame.grid(row=x,column=y,columnspan=2,sticky='news')
        ...
        self.CO2_LD_button.grid(row=x+1, column=y+1, padx=20, pady=10, sticky="nw")
        ...
        self.N2O_LD_button.grid(row=x+1, column=y, padx=20, pady=10, sticky="news")
        ...
        self.CH4_LD_button.grid(row=x+1, column=y+2, padx=20, pady=10, sticky="es")
    ...
    def DataInterface(self,x,y):
        ...
        #self.Collect_Data = tk.Button(self.DataFrame, text='Collect Data', fg='black',bd=3,relief='raised', command=lambda: self.ard.collect_Data('NO2',self.measurement_duration))
    ...
    def Machine_States(self,x,y):
        ...
        self.Machine_Label.grid(row=x, column=y,columnspan=2, sticky='wen')
        ...
        self.Door_Label_txt.grid(row=x+1, column=y+1, sticky='e')
    ...
    def LD_States(self,x,y):
        ...
        self.InfoFrame.grid(row=x,column=y,rowspan=4,sticky='news')
